    ...
    <div className="min-h-screen bg-[#0D0E14] flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-4 py-4">
        ...
        <div className="space-y-2.5">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[#30D158]/10 text-[#30D158] flex-shrink-0 p-2">
          ...
          <div className="flex items-center gap-4 p-4 rounded-xl border transition-all duration-150 bg-[#161720]/50 border-[#252638]/50 opacity-60 cursor-default">
            <div className="w-10 h-10 rounded-xl bg-[#7C6FF7]/10 text-[#7C6FF7] flex-shrink-0 p-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-full h-full">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-[#252638] text-[#55556A] text-[10px] font-medium">
...
function ArrowRight({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`w-4 h-4 flex-shrink-0 transition-transform group-hover:translate-x-0.5 ${className ?? ''}`}>
